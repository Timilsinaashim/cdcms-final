...
<div class="content py-3">
    <div class="container-fluid">
        <div class="card card-outline card-info shadow rounded-0">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    <form action="" id="babysitter-form" enctype="multipart/form-data" > 
                      ...
                      <legend class="text-navy">Image</legend>
                          <div class="row">
                           <div class="col-sm-form-group col-md-6">
                          <label for="img" class="control-label text-muted">Choose Image</label>
                           <input type="file" id="img" name="img" class="form-control form-control-border" accept="image/png,image/jpeg" onchange="displayImg(this, $('#cimg'))">
                               </div>
                     </div>
                  <div class="row">
                             <div class="form-group col-md-6">
                     <center>
                <img src="<?= isset($id) ? "uploads/babysitters/{$id}.png" : "" ?>" alt="Babysitter Image" id="cimg" class="bg-gradient-dark">
            </center>
        </div>
    </div>
</fieldset>
